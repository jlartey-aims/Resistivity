...
class FieldsMMR_CC(SimPEG.Problem.Fields):
    ...
    def __init__(self, mesh, survey, **kwargs):
        SimPEG.Problem.Fields.__init__(self, mesh, survey, **kwargs)
